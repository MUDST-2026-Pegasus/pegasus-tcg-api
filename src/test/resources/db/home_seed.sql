...
SELECT g.id, v.code, v.name, v.name_local, v.release_date::date, v.total_cards
  FROM (VALUES
        ...
        ('YUGIOH', 'RA03', 'Quarter Century Bonanza', NULL, '2024-11-07', 180),
...
SELECT g.id, c.id, s.id, v.product_type, v.name, v.name_local, v.slug,
  ...
  FROM (VALUES
        ...
        ('POKEMON', 'PRE', 'SINGLES', 'SINGLE_CARD', 'Eevee ex SIR', 'อีวุย ex', 'eevee-ex-sir-167-131', '167/131', 'SIR', 'Eevee ex, Special Illustration Rare.', '{}', 6),
        ...
        ('POKEMON', 'ME01', 'SINGLES', 'SINGLE_CARD', 'Mega Lucario ex SIR', 'เมก้าลูคาริโอ ex', 'mega-lucario-ex-sir-179-132', '179/132', 'SIR', 'Mega Lucario ex, Special Illustration Rare.', '{}', 1),
        ('POKEMON', 'ME01', 'SINGLES', 'SINGLE_CARD', 'Mega Gardevoir ex SIR', 'เมก้าเซอไนต์ ex', 'mega-gardevoir-ex-sir-178-132', '178/132', 'SIR', 'Mega Gardevoir ex, Special Illustration Rare.', '{"card_type":"Psychic","stage":"Stage 2"}', 2),
        ...
        ('MTG', 'FIN', 'SINGLES', 'SINGLE_CARD', 'Cloud, Midgar Mercenary', 'คลาวด์', 'cloud-midgar-mercenary-fin-10', '10', 'M', 'Mythic rare legendary creature, foil.', '{}', 28),
        ...
        ('YUGIOH', 'RA03', 'SINGLES', 'SINGLE_CARD', 'Blue-Eyes White Dragon', 'มังกรขาวตาสีฟ้า', 'blue-eyes-white-dragon-ra03-en079', 'RA03-EN079', 'QCSR', 'Quarter Century Secret Rare.', '{}', 26),
        ('YUGIOH', 'RA03', 'SINGLES', 'SINGLE_CARD', 'Dark Magician', 'จอมเวทย์ทมิฬ', 'dark-magician-ra03-en080', 'RA03-EN080', 'QCSR', 'Quarter Century Secret Rare.', '{}', 26),
        ...
        ('DIGIMON', 'BT20', 'SINGLES', 'SINGLE_CARD', 'Omnimon (X Antibody) SEC', 'โอเมก้ามอน', 'omnimon-x-antibody-sec-bt20-102', 'BT20-102', 'SEC', 'Secret Rare Omnimon (X Antibody).', '{}', 16),
...
SELECT p.id, v.sku, v.language_code, v.finish, v.edition
  FROM (VALUES
        ...
        ('eevee-ex-sir-167-131', 'POKEMON-PRE-167-131-EN-NORMAL', 'EN', 'NORMAL', 'UNLIMITED'),
        ...
        ('mega-lucario-ex-sir-179-132', 'POKEMON-ME01-179-132-EN-NORMAL', 'EN', 'NORMAL', 'UNLIMITED'),
        ('mega-gardevoir-ex-sir-178-132', 'POKEMON-ME01-178-132-EN-NORMAL', 'EN', 'NORMAL', 'UNLIMITED'),
        ...
        ('cloud-midgar-mercenary-fin-10', 'MTG-FIN-10-EN-FOIL', 'EN', 'FOIL', 'UNLIMITED'),
        ...
        ('blue-eyes-white-dragon-ra03-en079', 'YUGIOH-RA03-EN079-EN-NORMAL', 'EN', 'NORMAL', 'UNLIMITED'),
        ('dark-magician-ra03-en080', 'YUGIOH-RA03-EN080-EN-NORMAL', 'EN', 'NORMAL', 'UNLIMITED'),
        ...
        ('omnimon-x-antibody-sec-bt20-102', 'DIGIMON-BT20-102-EN-NORMAL', 'EN', 'NORMAL', 'UNLIMITED'),
...
SELECT p.id, v.image_key, v.alt_text, 0, true
  FROM (VALUES
        ...
        ('eevee-ex-sir-167-131', 'seed/products/eevee-ex-sir-167-131.jpg', 'Eevee ex SIR'),
        ...
        ('mega-lucario-ex-sir-179-132', 'seed/products/mega-lucario-ex-sir-179-132.jpg', 'Mega Lucario ex SIR'),
        ('mega-gardevoir-ex-sir-178-132', 'seed/products/mega-gardevoir-ex-sir-178-132.jpg', 'Mega Gardevoir ex SIR'),
        ...
        ('cloud-midgar-mercenary-fin-10', 'seed/products/cloud-midgar-mercenary-fin-10.jpg', 'Cloud, Midgar Mercenary'),
        ...
        ('blue-eyes-white-dragon-ra03-en079', 'seed/products/blue-eyes-white-dragon-ra03-en079.jpg', 'Blue-Eyes White Dragon'),
        ('dark-magician-ra03-en080', 'seed/products/dark-magician-ra03-en080.jpg', 'Dark Magician'),
        ...
        ('omnimon-x-antibody-sec-bt20-102', 'seed/products/omnimon-x-antibody-sec-bt20-102.jpg', 'Omnimon (X Antibody) SEC'),
...
SELECT sp.id, cv.id, v.condition_code, v.grading_company, v.grade_value::numeric,
  ...
  FROM (VALUES
        ...
        ('tcg_corner', 'POKEMON-ME01-179-132-EN-NORMAL', 'NM', '2450.00', 0, NULL, NULL, NULL),
        ('mint_vault', 'POKEMON-ME01-179-132-EN-NORMAL', 'NM', '2600.00', 0, NULL, NULL, NULL),
        ('card_kingdom_th', 'POKEMON-ME01-179-132-EN-NORMAL', 'NM', '2380.00', 0, NULL, NULL, NULL),
        ('mint_vault', 'POKEMON-ME01-179-132-EN-NORMAL', 'LP', '2010.00', 0, NULL, NULL, 'Light edge wear, see photos.'),
        ('mint_vault', 'POKEMON-ME01-178-132-EN-NORMAL', 'NM', '1890.00', 1, NULL, NULL, NULL),
        ('card_kingdom_th', 'POKEMON-ME01-178-132-EN-NORMAL', 'NM', '2000.00', 0, NULL, NULL, NULL),
        ('card_kingdom_th', 'POKEMON-ME01-178-132-EN-NORMAL', 'LP', '1550.00', 0, NULL, NULL, 'Light edge wear, see photos.'),
        ...
        ('card_kingdom_th', 'MTG-FIN-10-EN-FOIL', 'NM', '1890.00', 27, NULL, NULL, NULL),
        ('tcg_corner', 'MTG-FIN-10-EN-FOIL', 'NM', '2000.00', 26, NULL, NULL, NULL),
        ('tcg_corner', 'MTG-FIN-10-EN-FOIL', 'LP', '1550.00', 25, NULL, NULL, 'Light edge wear, see photos.'),
        ...
        ('mint_vault', 'YUGIOH-RA03-EN079-EN-NORMAL', 'NM', '5990.00', 25, NULL, NULL, NULL),
        ('card_kingdom_th', 'YUGIOH-RA03-EN079-EN-NORMAL', 'NM', '6350.00', 24, NULL, NULL, NULL),
        ('tcg_corner', 'YUGIOH-RA03-EN079-EN-NORMAL', 'NM', '5810.00', 23, NULL, NULL, NULL),
        ('card_kingdom_th', 'YUGIOH-RA03-EN079-EN-NORMAL', 'LP', '4910.00', 23, NULL, NULL, 'Light edge wear, see photos.'),
        ('card_kingdom_th', 'YUGIOH-RA03-EN080-EN-NORMAL', 'NM', '3490.00', 25, NULL, NULL, NULL),
        ('tcg_corner', 'YUGIOH-RA03-EN080-EN-NORMAL', 'NM', '3700.00', 24, NULL, NULL, NULL),
        ('tcg_corner', 'YUGIOH-RA03-EN080-EN-NORMAL', 'LP', '2860.00', 23, NULL, NULL, 'Light edge wear, see photos.'),
        ...
        ('mint_vault', 'DIGIMON-BT20-102-EN-NORMAL', 'NM', '1490.00', 15, NULL, NULL, NULL),
        ('card_kingdom_th', 'DIGIMON-BT20-102-EN-NORMAL', 'NM', '1580.00', 14, NULL, NULL, NULL),
        ('tcg_corner', 'DIGIMON-BT20-102-EN-NORMAL', 'NM', '1450.00', 13, NULL, NULL, NULL),
        ('card_kingdom_th', 'DIGIMON-BT20-102-EN-NORMAL', 'LP', '1220.00', 13, NULL, NULL, 'Light edge wear, see photos.'),
...
SELECT l.seller_profile_id, l.catalog_variant_id, l.condition_code, l.id, 'LISTED',
  ...
  FROM (VALUES
        ...
        ('card_kingdom_th', 'MTG-FIN-10-EN-FOIL', 'NM', NULL, 1),
        ('tcg_corner', 'MTG-FIN-10-EN-FOIL', 'NM', NULL, 2),
        ('tcg_corner', 'MTG-FIN-10-EN-FOIL', 'LP', NULL, 1),
        ...
        ('mint_vault', 'YUGIOH-RA03-EN079-EN-NORMAL', 'NM', NULL, 3),
        ('card_kingdom_th', 'YUGIOH-RA03-EN079-EN-NORMAL', 'NM', NULL, 1),
        ('tcg_corner', 'YUGIOH-RA03-EN079-EN-NORMAL', 'NM', NULL, 2),
        ('card_kingdom_th', 'YUGIOH-RA03-EN079-EN-NORMAL', 'LP', NULL, 1),
        ('card_kingdom_th', 'YUGIOH-RA03-EN080-EN-NORMAL', 'NM', NULL, 1),
        ('tcg_corner', 'YUGIOH-RA03-EN080-EN-NORMAL', 'NM', NULL, 2),
        ('tcg_corner', 'YUGIOH-RA03-EN080-EN-NORMAL', 'LP', NULL, 1),
        ...
        ('mint_vault', 'DIGIMON-BT20-102-EN-NORMAL', 'NM', NULL, 3),
        ('card_kingdom_th', 'DIGIMON-BT20-102-EN-NORMAL', 'NM', NULL, 1),
        ('tcg_corner', 'DIGIMON-BT20-102-EN-NORMAL', 'NM', NULL, 2),
        ('card_kingdom_th', 'DIGIMON-BT20-102-EN-NORMAL', 'LP', NULL, 1),
...
SELECT v.order_number, v.buyer, v.seller, v.sku, v.condition_code, v.quantity,
  ...
  FROM (VALUES
        ...
        ('PGS-SEED-000016', 'collector_mai', 'card_kingdom_th', 'MTG-FIN-10-EN-FOIL', 'NM', 2, '1890.00', 18, 'Cloud, Midgar Mercenary', 'EN / FOIL / UNLIMITED', 'Magic: The Gathering', 'seed/products/cloud-midgar-mercenary-fin-10.jpg'),
        ('PGS-SEED-000017', 'deckbuilder_ton', 'card_kingdom_th', 'POKEMON-ME01-179-132-EN-NORMAL', 'NM', 1, '2380.00', 0, 'Mega Lucario ex SIR', 'EN / NORMAL / UNLIMITED', 'Pokemon TCG', 'seed/products/mega-lucario-ex-sir-179-132.jpg'),
